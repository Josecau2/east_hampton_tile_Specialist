        ...
        <div className="mb-8 flex flex-col justify-between gap-6 md:mb-12 md:flex-row md:items-end">
          <div>
            ...
            {demoUrl && demoText && (
              <a
                href={demoUrl}
                className="group inline-flex items-center gap-1 text-sm font-medium md:text-base"
              >
                {demoText}
            ...
            {items.map((item) => (
              ...
              >
                <a href={item.url} className="group flex flex-col">
                  ...
                  <div className="mb-2 line-clamp-2 pt-4 text-lg font-medium break-words md:text-xl">
                    {item.title}
                  </div>
