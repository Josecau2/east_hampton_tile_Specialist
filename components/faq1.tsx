...
const Faq1 = ({
  ...
  return (
    <section className={cn("py-20 md:py-32", className)} id="faq">
        ...
        <Accordion type="single" collapsible>
          {items.map((item, index) => (
            <AccordionItem key={index} value={`item-${index}`} className="border-b-2 border-border">
              <AccordionTrigger className="font-bold text-left hover:no-underline hover:text-primary transition-colors">
                {item.question}
              </AccordionTrigger>
